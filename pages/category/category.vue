<template>
	<view class="category-container">
		...
		<view class="gallery">
			<view v-for="(item,index) in photoList" :key="index" class="photo-card" @click="viewPhotoDetail(item)">
				...
				<view class="photo-info">
					...
					<image :src="item.liked ? '/static/heart-outlined.png' : '/static/heart-filled.png'"
		...
		<!-- 使用筛选组件 -->
		<FilterModal ref="filterModal" :initialPeople="filter.people" :initialScene="filter.scene"
