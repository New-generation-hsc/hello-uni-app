	...
	<view class="container">
		<view class="content">
			...
			<view class="photo-container">
				...
				<!-- 收藏按钮 -->
				<view class="favorite-btn" :class="{'hover-effect': isHovered}" @touchstart="toggleHover(true)"
					@touchend="toggleHover(false)" @click="toggleFavorite">
					<image :src="isFavorite ? '/static/heart-filled.png' : '/static/heart-outlined.png'"
